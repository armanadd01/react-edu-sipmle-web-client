        ...
        <div className="container-fluid border-bottom border-primary"> 
            ...
            <div className="header-bottom">
                <div className="navbar navbar navbar-expand-lg navbar-light">
                    {/* Site logo */}
                    <div className="col-md-3  col-12 navbar-brand text-center">
                        <img className="w-25 h-25" src={logoImg} alt="" />
                    </div>
                    {/* Navigation bar */}
                    <div className="main-menu col-md-5 col-12 text-center">
                    ...
                    <div className="search-menu col-md-4 col-12 d-flex pe-4">
